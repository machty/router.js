define("router",
  ...
  function(RouteRecognizer, RSVP) {
    ...
    */
    ...
    function trigger(router, ignoreFailure, args) {
    ...
    function performTransition(router, recogHandlers, providedModelsArray, params, data) {
      ...
      // Fire 'willTransition' event on current handlers.
      trigger(router, true, ['willTransition', transition]);
    ...
    function validateEntry(transition, handlerInfos, index, matchPoint) {
      ...
      function model() {
        ...
        return getModel(handlerInfo, transition, index >= matchPoint);
      }
